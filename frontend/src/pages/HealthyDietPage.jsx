...
const HealthyDietPage = () => {
  ...
  const dietPlans = {
    children: {
      ...
      image: "https://static.vecteezy.com/system/resources/thumbnails/035/778/532/small/ai-generated-three-children-happily-smiling-in-a-field-of-daisies-enjoying-the-beauty-of-nature-and-the-warmth-of-the-sun-generative-ai-photo.jpeg",
      meals: {
    ...
    adults: {
      ...
      image: "https://www.shutterstock.com/image-photo/diverse-team-project-managers-enjoying-260nw-2532428491.jpg",
      meals: {
    ...
    elders: {
      ...
      image: "https://www.shutterstock.com/image-illustration/active-senior-couple-holding-hands-260nw-2524336771.jpg",
      meals: {
          ...
          {Object.entries(dietPlans).map(([key, plan]) => (
            <div key={key} className="bg-white rounded-xl shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <h3 className="font-medium text-gray-700 mb-2">Daily Meal Plan:</h3>
                  <ul className="space-y-2">
                    <li><span className="font-medium">Breakfast:</span> {plan.meals.breakfast}</li>
                    <li><span className="font-medium">Lunch:</span> {plan.meals.lunch}</li>
                    <li><span className="font-medium">Snack:</span> {plan.meals.snack}</li>
                    <li><span className="font-medium">Dinner:</span> {plan.meals.dinner}</li>
                  </ul>
                </div>
                
                <div>
                  <h3 className="font-medium text-gray-700 mb-2">Health Tips:</h3>
